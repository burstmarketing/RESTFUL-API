...
class Core_APITest extends PHPUnit_Framework_TestCase {
  ...
  public function testLoadedConfigIsOfTypeZendConfigJson() {
    // Real config, _config should be an instance of Zend\Config\Config
    $this->object->loadConfig(ASSEMBLA_REST_API_ROOT . '/../Assembla/etc/config.json');

    $this->assertAttributeInstanceOf('Zend\Config\Config', '_config', $this->object);
  }
  ...
  public function testGetConfigNonExistentUriReturnsFalse() {
    ...
    $this->assertNull($this->object->getConfig('non-existent-key-with-no-slash'));
  }
  ...
  public function testSetConfig() {
    ...
    $this->assertNull($this->object->getConfig('non-existent-key'));
  ...
  public function testGetServiceReturnsCoreAPIService() {
    $this->object->loadConfig(ASSEMBLA_REST_API_ROOT . '/../Assembla/etc/config.json');

    // Make sure it returns a Zend\Config\Config object for an existing service
    $this->assertInstanceOf('Core_API_Service', $this->object->getService('ticket_by_id'));
  }
