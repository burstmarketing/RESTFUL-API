 ...
 *
 * @category   Blast
 * @package    Blast_Simplexml
 * @copyright  Copyright (c) 2008 Irubin Consulting Inc. DBA Blast (http://www.varien.com)
 ...
 */
class Blast_Simplexml_Element extends SimpleXMLElement
{
     ...
     * For future use
     *
     * @param Blast_Simplexml_Element $element
     */
     ...
     *
     * @return Blast_Simplexml_Element
     */
...
*/
    ...
    protected function _asArray($isCanonical = false)
    {
        ...
        if (!$isCanonical) {
            ...
            foreach ($this->attributes() as $attributeName => $attribute) {
                if ($attribute) {
                    $result['attr'][$attributeName] = (string)$attribute;
                }
            }
        }
        // add children values
		...
		if( isset( $attrs['@attributes']['type'] ) && $attrs['@attributes']['type'] == 'array' ):
            ...
            if (empty($result)) {
                ...
                $result = trim((string) $this);
            } else {
                // value has zero key element
                $result['value'] = trim((string) $this);
            }
        }
        return $result;
    }
     ...
     *
     * @param Blast_Simplexml_Element $source
     * @return Blast_Simplexml_Element
     */
    ...
    {
        if (!$source instanceof Blast_Simplexml_Element) {
            return $this;
        }
